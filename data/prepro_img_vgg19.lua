...
cmd:text()
cmd:text('Options')
cmd:option('-inputJson', 'visdial/chat_processed_params.json', 'Path to JSON file')
cmd:option('-imageRoot', '/path/to/images/', 'Path to COCO image root')
cmd:option('-cnnProto', 'models/vgg19/VGG_ILSVRC_19_layers_deploy.prototxt', 'Path to the CNN prototxt')
cmd:option('-cnnModel', 'models/vgg19/VGG_ILSVRC_19_layers.caffemodel', 'Path to the CNN model')
